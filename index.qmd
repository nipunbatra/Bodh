...
## Live Demo - Single Example, Multiple Styles

**Comprehensive Gradient Descent Tutorial** demonstrating all features with different themes and configurations:

:::{.examples-grid}

::: {.example-card}
### Modern Theme
Clean, professional design with Inter fonts  
...
::: {.example-card}
### Minimal Theme  
Ultra-clean design, no logo, generous whitespace  
...
::: {.example-card}
### Dark Theme
Professional dark theme with light text  
...
::: {.example-card}
### Academic Style
LaTeX backend, academic formatting, small fonts  
...
*Same comprehensive content, infinite styling possibilities*
